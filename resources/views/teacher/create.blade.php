                            ...
                            <div class="multisteps-form__content">
                                <div class="row mt-3">
                                    <div class="col">
                                        ...
                                        <input class="multisteps-form__input form-control" type="text"
                                            placeholder="eg. Street 111" onfocus="focused(this)"
                                            onfocusout="defocused(this)">
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col">
                                        ...
                                        <input class="multisteps-form__input form-control" type="text"
                                            placeholder="eg. Street 221" onfocus="focused(this)"
                                            onfocusout="defocused(this)">
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    ...
                                    <div class="col-6 col-sm-3 mt-3 mt-sm-0">
                                        <label>Zip</label>
                                        <input class="multisteps-form__input form-control" type="text"
                                            placeholder="7 letters" onfocus="focused(this)"
                                            onfocusout="defocused(this)">
                                    </div>
                                </div>
                                <div class="button-row d-flex mt-4">
                            ...
                            <div class="multisteps-form__content">
                                <div class="row mt-3">
                                    ...
                                    <div class="col-12 mt-3">
                                        ...
                                        <input class="multisteps-form__input form-control" type="text"
                                            placeholder="https://..." onfocus="focused(this)"
                                            onfocusout="defocused(this)">
                                    </div>
                                    <div class="col-12 mt-3">
