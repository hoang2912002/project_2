...
<body class="">
    ...
    <div class="container d-flex position-sticky z-index-sticky top-0">
        <div class="row">
            <div class="col-12">
                <nav
                    class="navbar navbar-expand-lg blur border-radius-lg top-0 z-index-3 shadow position-absolute mt-4 py-2 start-0 end-0 mx-4">
                    <div class="container-fluid ps-0 pe-0 al d-flex align-items-center">
                        <a style="align-items: center" class=" navbar-brand font-weight-bolder  ms-lg-3 ms-3  align-items-center"
                            href="#">
                            Attendance website
                        </a>
                    </div>
